...
class TelegramOutputAdapter:
    ...
    async def send(self, message: OutboundMessage) -> None:
        ...
        chat_id = _resolve_chat_id(message=message, default_chat_id=self.default_chat_id)
        if not chat_id:
...
def _resolve_chat_id(*, message: OutboundMessage, default_chat_id: str | None) -> str | None:
