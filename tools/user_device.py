...
class UserDeviceTool(BaseTool):
    ...
    description: str = "Controls user device actions like location, flashlight, or find phone."
    ...
    async def _arun(
        ...
        if normalized == "user_location":
            ...
            return f"User location is {location.latitude:.5f}, {location.longitude:.5f}."
