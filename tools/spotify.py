...
class SpotifyTool(BaseTool):
    ...
    description: str = "Control Spotify playback or query current state."
...
registry.register(
    "spotify_tool",
    description="Control Spotify playback or query current state.",
    toolset="entertainment",
    requires_env=["SPOTIFY_CLIENT_ID", "SPOTIFY_CLIENT_SECRET"],
    factory=lambda **kw: [SpotifyTool()],
)
...
async def _match_track(
    ...
    *,
    ...
    artist_items = list(((artist_search or {}).get("artists") or {}).get("items") or [])
