...
from agent.orchestration import OutputSink
...
class ReminderTool(BaseTool):
    ...
    description: str = "Set or cancel reminders."
...
registry.register(
    "reminder_tool",
    description="Set or cancel reminders.",
    toolset="utility",
    factory=lambda output=None, **kw: [ReminderTool(output=output)] if output else [],
)
